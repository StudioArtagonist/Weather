...
import com.studioartagonist.weather.databinding.ForecastItemRowBinding
import com.studioartagonist.weather.models.ForecastWeatherModel

class ForecastAdapter : ListAdapter<ForecastWeatherModel.ForecastList, ForecastAdapter.ForecastViewHolder>(ForecastDiffUtil()) {
